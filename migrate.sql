...
INSERT IGNORE INTO projects (project_id, parent_id, url, title, order_number, banner_hidden, project_hidden)
  ...
  WHERE parent_id IS NOT NULL
        AND exists(SELECT * FROM projects WHERE project_id = f.parent_id);
...
INSERT INTO volumes (volume_id, project_id, url, name_file, name_title, name_jp, name_en, name_ru, name_short,
  ...
  SELECT
    release_id,
    ifnull(series_id, (SELECT project_id FROM projects WHERE url = name_url)),
...
INSERT INTO updates (project_id, volume_id, chapter_id, update_type, show_time, description)
  SELECT
    coalesce((SELECT parent_id FROM projects WHERE series_id = project_id),
             series_id,
             (SELECT project_id FROM projects WHERE url = name_url)),
    release_id,
    chapter_id,
    CASE u.type
...
UPDATE projects SET name_jp = 'ソードアート・オンライン', name_en = 'Sword Art Online', name_ru = NULL WHERE project_id = 1;
UPDATE projects SET name_jp = 'ログ・ホライズン', name_en = 'Log Horizon', name_ru = NULL WHERE project_id = 3;
UPDATE projects SET name_jp = '狼と香辛料', name_en = 'Spice and Wolf', name_ru = 'Волчица и пряности' WHERE project_id = 7;
UPDATE projects SET name_jp = 'デュラララ!!', name_en = 'Durarara!!', name_ru = 'Дюрарара!!' WHERE project_id = 8;
UPDATE projects SET name_jp = '魔法科高校の劣等生', name_en = 'Mahouka Koukou no Rettousei',
  name_ru                   = 'Непутевый ученик в школе магии' WHERE project_id = 9;
UPDATE projects SET name_jp = 'ヘヴィーオブジェクト', name_en = 'Heavy Object', name_ru = 'Тяжелый Объект' WHERE project_id = 11;
UPDATE projects SET name_jp = 'アクセル・ワールド', name_en = 'Accel World', name_ru = 'Ускоренный мир' WHERE project_id = 12;
UPDATE projects SET name_jp = '終わりのクロニクル', name_en = 'Owari no Chronicle',
  name_ru                   = 'Хроники конца света' WHERE project_id = 13;
UPDATE projects SET name_jp = '中二病でも恋がしたい!', name_en = NULL,
  name_ru                   = 'У неё синдром восьмиклассника, но я всё равно хочу любить её!' WHERE project_id = 14;
UPDATE projects SET name_jp = 'オール・ユー・ニード・イズ・キル', name_en = 'All You Need Is Kill',
  name_ru                   = 'Тебе Лишь Нужно Убивать' WHERE project_id = 15;
UPDATE projects SET name_jp = 'ノーゲーム．ノーライフ', name_en = 'No Game No Life', name_ru = NULL WHERE project_id = 17;
UPDATE projects SET name_jp = 'さまよう神姫の剣使徒', name_en = 'The Wandering Goddess'' Duelist',
  name_ru                   = 'Дуэлянт странствующей богини' WHERE project_id = 18;
UPDATE projects SET name_jp = '東京レイヴンズ', name_en = 'Tokyo Ravens', name_ru = 'Токийские вороны' WHERE project_id = 24;
UPDATE projects SET name_jp = 'とらドラ！', name_en = 'ToraDora!', name_ru = NULL WHERE project_id = 25;
UPDATE projects SET name_jp = 'やはり俺の青春ラブコメはまちがっている', name_en = NULL, name_ru = NULL WHERE project_id = 26;
UPDATE projects SET name_jp = 'エロマンガ先生', name_en = 'EroManga Sensei', name_ru = 'Эроманга-сэнсэй' WHERE project_id = 27;
UPDATE projects SET name_jp = '問題児たちが異世界から来るそうですよ?',
  name_en                   = 'Problem Children are Coming from Another World, Aren''t They?',
  name_ru                   = 'Проблемные дети приходят из другого мира, верно?' WHERE project_id = 28;
UPDATE projects SET name_jp = 'とある魔術の禁書目録', name_en = 'Toaru Majutsu no Index',
  name_ru                   = 'Некий Магический Индекс' WHERE project_id = 29;
UPDATE projects SET name_jp = '魔弾の王と戦姫', name_romaji = 'Madan no Ou to Vanadis', name_ru = NULL WHERE project_id = 33;
UPDATE projects SET name_jp = '盾の勇者の成り上がり', name_romaji = 'Tate no Yuusha no Nariagari',
  name_ru                   = 'Становление Героя Щита' WHERE project_id = 34;
UPDATE projects SET name_jp = '棺姫のチャイカ', name_en = 'Chaika - The Coffin Princess',
  name_ru                   = 'Чайка − принцесса с гробом' WHERE project_id = 35;
UPDATE projects SET name_jp = 'マグダラで眠れ', name_en = 'May your soul rest in Magdala',
  name_ru                   = 'Пусть твоя душа упокоится в Магдале' WHERE project_id = 37;
UPDATE projects SET name_jp = 'さくら荘のペットな彼女', name_romaji = 'Sakurasou no Pet na Kanojo',
  name_ru                   = 'Кошечка из Сакурасо' WHERE project_id = 38;
UPDATE projects SET name_jp = 'オーバーロード', name_en = 'Overlord', name_ru = 'Властелин' WHERE project_id = 39;
UPDATE projects SET name_jp = 'レンタルマギカ', name_en = 'Rental Magica', name_ru = NULL WHERE project_id = 43;
UPDATE projects SET name_jp = '黙示録アリス', name_en = 'Apocalypse Alice', name_ru = NULL WHERE project_id = 44;
UPDATE projects SET name_jp = 'ダンジョンに出会いを求めるのは間違っているだろうか', name_ru = NULL,
  name_romaji               = 'Dungeon ni Deai wo Motomeru no wa Machigatteiru Darou ka' WHERE project_id = 45;
UPDATE projects SET name_jp = '新妹魔王の契約者（テスタメント）',
  name_romaji               = 'Shinmai Maou no Tesutamento', name_ru = NULL WHERE project_id = 46;
UPDATE projects SET name_jp = 'ハイスクールD×D', name_en = 'High School D×D', name_ru = NULL WHERE project_id = 48;
UPDATE projects SET name_jp = '世界の終わりの世界録',
  name_romaji               = 'Sekai no Owari no Encore', name_ru = NULL WHERE project_id = 49;
